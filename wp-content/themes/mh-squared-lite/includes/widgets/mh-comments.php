...
class mh_squared_lite_comments extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_squared_lite_comments', 'description' => esc_html__('MH Recent Comments widget to display your recent comments including user avatars.', 'mh-squared-lite'))
		);
	}
