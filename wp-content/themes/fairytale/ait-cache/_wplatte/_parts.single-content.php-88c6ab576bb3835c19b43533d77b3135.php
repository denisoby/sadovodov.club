<?php //netteCache[01]000477a:2:{s:4:"time";s:21:"0.41965300 1437883955";s:9:"callbacks";a:3:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:88:"/opt/sites/sadovodov.club/wp-content/themes/fairytale/Templates/parts/single-content.php";i:2;i:1437883843;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"eee17d5 released on 2011-08-13";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:21:"WPLATTE_CACHE_VERSION";i:2;i:4;}}}?><?php

// source file: /opt/sites/sadovodov.club/wp-content/themes/fairytale/Templates/parts/single-content.php

?><?php list($_l, $_g) = NCoreMacros::initRuntime($template, 'eiwkl4jf7y')
;
// snippets support
...
<?php if (!$post->hasFormat('aside') and !$post->hasFormat('link') and $post->type == 'post'): NCoreMacros::includeTemplate("entry-date.php", $template->getParams(), $_l->templates['eiwkl4jf7y'])->render() ;endif ?>
...
<?php NCoreMacros::includeTemplate("post-meta.php", $template->getParams(), $_l->templates['eiwkl4jf7y'])->render() ;if ($post->isSingle and $post->author->bio and $post->isMultiAuthor): NCoreMacros::includeTemplate("author-bio.php", $template->getParams(), $_l->templates['eiwkl4jf7y'])->render() ;endif ?>
	</footer>
<?php endif ;endif ;
