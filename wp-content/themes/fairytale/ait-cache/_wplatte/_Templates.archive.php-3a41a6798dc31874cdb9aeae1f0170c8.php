<?php //netteCache[01]000464a:2:{s:4:"time";s:21:"0.78409100 1445296284";s:9:"callbacks";a:3:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:75:"/opt/sites/sadovodov.club/wp-content/themes/fairytale/Templates/archive.php";i:2;i:1437883843;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"eee17d5 released on 2011-08-13";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:21:"WPLATTE_CACHE_VERSION";i:2;i:4;}}}?><?php

// source file: /opt/sites/sadovodov.club/wp-content/themes/fairytale/Templates/archive.php

?><?php list($_l, $_g) = NCoreMacros::initRuntime($template, '55xlhxx154')
;//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8665d8025d_content')) { function _lb8665d8025d_content($_l, $_args) { extract($_args)
?>
...
<?php NCoreMacros::includeTemplate("parts/posts-loop.php", array('posts' => $posts) + $template->getParams(), $_l->templates['55xlhxx154'])->render() ?>
				</div> <!-- /#content -->
...
<?php NCoreMacros::includeTemplate("parts/content-nav.php", array('location' => 'nav-below') + $template->getParams(), $_l->templates['55xlhxx154'])->render() ;else: ?>
				<div id="content" class="entry-content" role="main">
					<div class="wrapper">
<?php NCoreMacros::includeTemplate("parts/nothing-found.php", $template->getParams(), $_l->templates['55xlhxx154'])->render() ?>
					</div>
				</div>
<?php endif ?>
		</div>
